...
//     let fromText.value = toText.value;
//     let toText.value = tempText;
//     let selectTag[0].value = selectTag[1].value;
//     selectTag[1].value = tempLang;
//         };

//         exchageIcon.addEventListener("click", handleButtonClick);
//         return () => {
//           exchageIcon.removeEventListener("click", handleButtonClick);
//         };
//       }, []),
...
{/* <ScriptTag type="text/javascript" src="js/countries.js" />
...
{/* <div class="btn-container">
  ...
  <div>
      <a href="index.html"><button id="show-translator" class="tab" >translator</button></a>
  </div>

  <div>
      <a href="mynotes.html"> <button id="show-notes" class="tab" >notes</button></a>
  </div>
</div> */}
        // </div>
